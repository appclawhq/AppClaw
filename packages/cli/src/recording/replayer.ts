...
import { activateAppWithFallback } from '@appclaw/core/mcp/activate-app';
import { findElement, getPageSource } from '@appclaw/core/mcp/tools';
import type { ActionResult } from '@appclaw/core/llm/schemas';
import type { UIElement, CompactUIElement } from '@appclaw/core/perception/types';
import { detectPlatform } from '@appclaw/core/perception/screen';
...
import { compactElement } from '@appclaw/core/perception/element-filter';
import {
...
} from '@appclaw/core/agent/element-finder';
...
import type { ToolCallDecision } from '@appclaw/core/llm/provider';
